...
const Hero = () => {
  const dummyImages = [
    ...
    "https://www.dkorinteriors.com/wp-content/uploads/2021/10/Breakfast-Nooks-Ideas-by-DKOR-Interiors-3.jpg",
    ...
    "https://www.tollbrothers.com/blog/wp-content/uploads/2019/12/7-Estancia-Olimpico-Coastal_Kitchen_CC.jpg",
  ];
  ...
  return (
    <section className="relative overflow-hidden md:h-screen w-full">
      {/* Carousel Section */}
      ...
      <div className="absolute top-0 sm:top-32 md:top-0 w-full md:h-screen h-fit flex flex-col items-center justify-center p-4 sm:p-8 md:p-12 lg:p-16 z-10 text-center">
